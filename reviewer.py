...
- 핀테크·블록체인·디지털자산·가상자산·스테이블코인·간편결제
- 디지털 전환(DX/AX) 전략·조직·투자·역량강화
  → 임직원 대상 AX 워크숍·AI 교육도 그 회사의 전환 전략이므로 YES
- 디지털 채널로 제공되는 국경간 서비스
  → 해외송금 인프라, 외국인 비대면 계좌, 글로벌 QR결제망 등은 YES
- 보안 기술 (양자내성암호·PQC·제로트러스트·이상거래탐지)
- 디지털·데이터 역량 확보를 위한 인수·합병·지분투자
- 핀테크·간편결제사의 사업 재편·서비스 통합·법인 정리
  → "토스페이먼츠 흡수합병", "결제사업 통합" 등은 디지털 금융 구조 변화이므로 YES
...
- 인사·사외이사·조직개편·부고
- 오프라인 점포·지점·PB센터 개설
- 고객·청소년 대상 금융교육, 봉사·기부·CSR·후원
- 제도 자체를 다루는 규제·감독·제재·소송·국정감사
- 디지털과 무관한 대출 확대·점포망 확장·단순 실적 전망

판정 원칙:
- 기사의 핵심 주제가 디지털·AI·데이터·핀테크 기술이면 YES.
- 애매하면 YES로 답한다. 이 검토는 명백한 오탐만 걸러내는 2차 관문이고,
  1차 필터가 이미 관련성을 확인했다. 지나치게 엄격하면 정상 기사를 잃는다.
